...
type Seed = Omit<Project, "slug" | "image_url"> & {
  ...
  gallery?: number;
  /*
   * The row is already in the database from an earlier migration, so image
   * changes ship as an UPDATE keyed on slug rather than an INSERT — an INSERT
   * would hit ON CONFLICT DO NOTHING and silently change nothing.
   */
  existing?: boolean;
};
...
const raw: Seed[] = [
  ...
  { name: "Centrifugal Pump", category: "mechanical", img: "pump", gallery: 2, existing: true, featured: true, sort: 1,
  ...
  { name: "Butterfly Valve", category: "mechanical", img: "valve", gallery: 2, existing: true, sort: 2,
  ...
  { name: "Crane Pipe Connections", category: "mechanical", img: "crane", gallery: 2, existing: true, sort: 3,
    blurb: "3D + 2D assemblies of LUG, PIPE, BUMP and BAYONET joints in 90° and 360° positions.",
    tags: ["Assembly", "Piping"] },
  { name: "Foam Dispenser", category: "mechanical", img: "foam", gallery: 5, existing: true, featured: true, sort: 4,
  ...
  { name: "Two-Component Glue Mixer", category: "mechanical", img: "mixer", gallery: 2, existing: true, sort: 5,
    blurb: "Helical static mixer inside a housing, geometry tuned so two components blend fully in a single pass.",
    tags: ["CAD", "Flow"] },
  { name: "Pump Housing — Clamp", category: "mechanical", img: "clamp", gallery: 2, existing: true, sort: 6,
    blurb: "Print-ready pump-housing clamp delivered with fully dimensioned technical drawings.",
    tags: ["Print-ready", "Drawings"] },
  { name: "Ice Fishing Stand", category: "mechanical", img: "icefishing", gallery: 2, existing: true, sort: 7,
    blurb: "Complete 3D assembly of an ice-fishing stand with 2D general-dimension drawings.",
    tags: ["Assembly", "Product"] },
  { name: "Pergola Extrusion Kit", category: "mechanical", img: "pergola", gallery: 2, existing: true, sort: 8,
    blurb: "Pergola profiles with an internal aluminium reinforcement — four section variants.",
    tags: ["Extrusion", "Architecture"] },
  { name: "CNC Production Part", category: "mechanical", img: "cncpart", gallery: 2, existing: true, sort: 9,
    blurb: "Curved CNC part modelled from a 2D drawing and prepared for machining.",
    tags: ["CNC", "DFM"] },
  { name: "6061 Aluminium Bracket", category: "mechanical", img: "alu6061", gallery: 2, existing: true, sort: 10,
    blurb: "Motorsport bracket engineered for CNC machining from 6061 aluminium.",
    tags: ["CNC", "Automotive"] },
  { name: "DIY CNC Router Parts", category: "mechanical", img: "cncrouter", gallery: 2, existing: true, sort: 11,
    blurb: "Machined on a self-built, 3D-printed CNC router in 18 mm beech.",
    tags: ["CNC", "Woodwork"] },
  { name: "Massage Roller", category: "mechanical", img: "massager", gallery: 4, existing: true, sort: 12,
    blurb: "Foam-roller assembly with movable pins; hole and rod tolerances tuned for smooth motion.",
    tags: ["Assembly", "Consumer"] },
  { name: "T-Part", category: "mechanical", img: "tpart", gallery: 2, existing: true, sort: 13,
  ...
  { name: "The Back Dragon", category: "product", img: "backdragon", gallery: 3, existing: true, featured: true, sort: 14,
  ...
  { name: "Toothbrush", category: "product", img: "toothbrush", gallery: 2, existing: true, sort: 15,
    blurb: "Two-tone toothbrush prototype modelled and prepared for 3D printing.",
    tags: ["Product Design", "Consumer"] },
  { name: "Razer Naga Mouse", category: "product", img: "mouse", gallery: 2, existing: true, featured: true, sort: 16,
    blurb: "An existing gaming mouse reverse-measured part-by-part and rebuilt in SolidWorks.",
    tags: ["Reverse Eng.", "SolidWorks"] },
  { name: "Car Seat", category: "product", img: "carseat", gallery: 2, existing: true, sort: 17,
    blurb: "Automotive seat cushion modelled directly from a 3D scan file.",
    tags: ["Scan-to-CAD", "Automotive"] },
  { name: "Sophia Shelf", category: "product", img: "shelf", gallery: 2, existing: true, sort: 18,
  ...
  { name: "Trash Bin", category: "product", img: "trashbin", gallery: 3, existing: true, sort: 19,
    blurb: "A workshop sketch refined into a full technical assembly and finished renders.",
    tags: ["Sheet Metal", "Product"] },
  { name: "iPhone Case", category: "product", img: "iphonecase", gallery: 2, existing: true, sort: 20,
    blurb: "Perforated protective case modelled with full dimensioning.",
    tags: ["Product Design", "Consumer"] },
  { name: "Wheel Rim", category: "product", img: "rim", gallery: 2, existing: true, featured: true, sort: 21,
    blurb: "Modern wheel-model prototypes for a rim manufacturer, prototyped and 3D printed.",
    tags: ["Automotive", "Prototype"] },
  { name: "Plastic Bouquet", category: "product", img: "bouquet", gallery: 3, existing: true, sort: 22,
    blurb: "Decorative tulip-bouquet vase modelled and rendered for production.",
    tags: ["Product Design", "Consumer"] },
  { name: "Fishing Bait", category: "product", img: "fishingbait", gallery: 2, existing: true, sort: 23,
    blurb: "Designed and prototyped for a Danish company — now their best-selling bait.",
    tags: ["Product Design", "Prototype"] },
  { name: "Children's Toy Car", category: "product", img: "toycar", gallery: 3, existing: true, sort: 24,
    blurb: "Pull-back toy car with a full internal gear-train, designed and printed.",
    tags: ["Mechanism", "Toy"] },
  { name: "Benda Pals Toy", category: "product", img: "bendapals", gallery: 2, existing: true, sort: 25,
    blurb: "Poseable creature toy with head, limbs and wings modelled separately for printing.",
    tags: ["Toy", "Print-ready"] },
  { name: "Front Man Mask", category: "product", img: "frontman", gallery: 2, existing: true, sort: 26,
    blurb: "Low-poly character mask, modelled and 3D printed.",
    tags: ["Cosplay", "Print"] },
  { name: "Alfa Romeo Grille", category: "product", img: "alfagrill", gallery: 2, existing: true, sort: 27,
    blurb: "A 40 × 35 cm front honeycomb grille for Alfa Romeo.",
    tags: ["Automotive", "Print"] },
  { name: "Rain Barrel", category: "product", img: "rainbarrel", gallery: 2, existing: true, sort: 28,
    blurb: "From a customer photo and sketch to a finished rain-barrel with a matching step stool.",
    tags: ["Concept-to-Part", "Product"] },
  { name: "Cooling Station", category: "product", img: "coolingstation", gallery: 2, existing: true, sort: 29,
  ...
  { name: "PET-G Replacement Parts", category: "printing", img: "petg", gallery: 2, existing: true, sort: 30,
    blurb: "Reverse-engineered replacement parts you can't buy anywhere, printed in PET-G.",
    tags: ["Reverse Eng.", "PET-G"] },
  { name: "Taipei 101", category: "printing", img: "taipei", gallery: 2, existing: true, featured: true, sort: 31,
    blurb: "Architectural scale model, modelled and 3D printed as a single piece.",
    tags: ["Scale Model", "Print"] },
  { name: "Reverse-Engineered Impeller", category: "printing", img: "impeller", gallery: 2, existing: true, featured: true, sort: 32,
    blurb: "Machine impeller rebuilt and printed with 5 walls at 100 % infill (250 g).",
    tags: ["Reverse Eng.", "Heavy-duty"] },
  { name: "PET-G Galaxy Sprocket", category: "printing", img: "petggear", gallery: 2, existing: true, sort: 33,
    blurb: "Factory machine sprocket 3D printed in PET-G for multi-purpose production.",
    tags: ["PET-G", "Spare Part"] },
  { name: "Biathlon Rifle Sight Part", category: "printing", img: "biathlon", gallery: 2, existing: true, sort: 34,
    blurb: "3D-printed sight component — 25 g vs 250 g makes a big difference over half a metre.",
    tags: ["Print", "Lightweight"] },
  { name: "Textured Bowls", category: "printing", img: "bowls", gallery: 2, existing: true, sort: 35,
    blurb: "Decorative faceted bowl printed to a salon's exact specification.",
    tags: ["Print", "Decorative"] },
  { name: "Devotional Statues", category: "printing", img: "statues", gallery: 2, existing: true, sort: 36,
    blurb: "Madonna statues printed at 20, 30 and 50 cm.",
    tags: ["Print", "Sculpture"] },
  { name: "GoPro Tank Mount", category: "printing", img: "gopro", gallery: 2, existing: true, sort: 37,
...
export const SEED_PROJECTS: Project[] = raw.map((p) => {
  const { img, sheet, gallery, existing, ...rest } = p;
  void existing;
